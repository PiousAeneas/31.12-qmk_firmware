...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [U_BASE] = LAYOUT_split_3x6_3( // Colemak-DH
    KC_NO,  RGUI_T(KC_Q),       ALGR_T(KC_W),   RCTL_T(KC_F),       RSFT_T(KC_P),       KC_B,                                                       KC_J,               LSFT_T(KC_L),       LCTL_T(KC_U),   ALGR_T(KC_Y),   LGUI_T(KC_QUOT), KC_NO,
    KC_NO,  LGUI_T(KC_A),       LALT_T(KC_R),   LCTL_T(KC_S),       LSFT_T(KC_T),       KC_G,                                                       KC_M,               RSFT_T(KC_N),       RCTL_T(KC_E),   LALT_T(KC_I),   RGUI_T(KC_O), KC_NO,
    KC_NO,  LT(U_BUTTON,KC_Z),  KC_X,           KC_C,               KC_D,               KC_V,                                                       KC_K,               KC_H,               KC_COMM,        KC_DOT,         LT(U_BUTTON,KC_SLSH), KC_NO,
                                                                    LT(U_SYS,KC_ESC),   LT(U_NAV,KC_SPC),   LT(U_MOUSE,KC_TAB), LT(U_SYM,KC_ENT),   LT(U_NUM,KC_BSPC),  LT(U_FUN,KC_DEL)
  ),

  [U_EXTRA] = LAYOUT_split_3x6_3( // QWERTY
  ...
  [U_BUTTON] = LAYOUT_split_3x6_3(
    ...
    KC_NO,  KC_LGUI,            KC_LALT,        KC_LCTL,            KC_LSFT,            U_UND,                                                      U_UND,              KC_LSFT,            KC_LCTL,        KC_LALT,        KC_LGUI, KC_NO,
    KC_NO,  U_UND,              U_CUT,          U_CPY,              U_PST,              U_RDO,                                                      U_RDO,              U_PST,              U_CPY,          U_CUT,          U_UND, KC_NO,
                                                                    KC_BTN3,            KC_BTN1,            KC_BTN2,            KC_BTN2,            KC_BTN1,            KC_BTN3
  ),

  [U_NAV] = LAYOUT_split_3x6_3(
    KC_NO,  OSM(MOD_RGUI),      OSM(MOD_RALT),  OSM(MOD_RCTL),      OSM(MOD_RSFT),      KC_NO,                                                      U_RDO,              U_PST,              U_CPY,          U_CUT,          U_UND, KC_NO,
    KC_NO,  OSM(MOD_LGUI),      OSM(MOD_LALT),  OSM(MOD_LCTL),      OSM(MOD_LSFT),      KC_NO,                                                      CW_TOGG,            KC_LEFT,            KC_DOWN,        KC_UP,          KC_RGHT, KC_NO,
    KC_NO,  KC_NUM_LOCK,        U_NPON,         TD(U_TD_U_NAV),     TD(U_TD_U_BASE),    KC_NO,                                                      KC_INS,             KC_HOME,            KC_PGDN,        KC_PGUP,        KC_END, KC_NO,
  ...
  [U_SYS] = LAYOUT_split_3x6_3(
    KC_NO,  OSM(MOD_RGUI),      OSM(MOD_RALT),  OSM(MOD_RCTL),      OSM(MOD_RSFT),      TD(U_TD_PSCR),                                              U_XWIN,             U_BRWSR_BCK,        U_TABB,         U_TABF,         U_BRWSR_FWD, KC_NO,
    KC_NO,  OSM(MOD_LGUI),      OSM(MOD_LALT),  OSM(MOD_LCTL),      OSM(MOD_LSFT),      KC_SCRL,                                                    U_SEARCH,           KC_MPRV,            KC_VOLD,        KC_VOLU,        KC_MNXT, KC_NO,
    KC_NO,  QK_BOOT,            TD(U_TD_MAC),   TD(U_TD_U_SYS),     TD(U_TD_U_BASE),    KC_PAUS,                                                    U_XFRZ,             U_XOUT,             U_XDECDEC,      U_XDECINC,      U_XIND, KC_NO,
                                                                    KC_NO,              KC_NO,              KC_NO,              KC_MSTP,            KC_MPLY,            KC_MUTE

  ),

  [U_NUM] = LAYOUT_split_3x6_3(
    KC_NO,  KC_LBRC,            KC_7,           KC_8,               KC_9,               KC_RBRC,                                                    KC_NO,              OSM(MOD_LSFT),      OSM(MOD_LCTL),  OSM(MOD_RALT),  OSM(MOD_LGUI), KC_NO,
    KC_NO,  KC_SCLN,            KC_4,           KC_5,               KC_6,               KC_EQL,                                                     KC_SPC,             OSM(MOD_RSFT),      OSM(MOD_RCTL),  OSM(MOD_LALT),  OSM(MOD_RGUI), KC_NO,
    KC_NO,  KC_GRV,             KC_1,           KC_2,               KC_3,               KC_BSLS,                                                    KC_NO,              TD(U_TD_U_BASE),    TD(U_TD_U_NUM), KC_DOT,         KC_SLSH, KC_NO,
                                                                    KC_DOT,             KC_0,               KC_MINS,            KC_NO,              KC_NO,              KC_NO
  ),

  [U_SYM] = LAYOUT_split_3x6_3(
    KC_NO,  KC_LCBR,            KC_AMPR,        KC_ASTR,            KC_LPRN,            KC_RCBR,                                                    KC_NO,              OSM(MOD_LSFT),      OSM(MOD_LCTL),  OSM(MOD_RALT),  OSM(MOD_LGUI), KC_NO,
    KC_NO,  KC_COLN,            KC_DLR,         KC_PERC,            KC_CIRC,            KC_PLUS,                                                    KC_SPC,             OSM(MOD_RSFT),      OSM(MOD_RCTL),  OSM(MOD_LALT),  OSM(MOD_RGUI), KC_NO,
    KC_NO,  KC_TILD,            KC_EXLM,        KC_AT,              KC_HASH,            KC_PIPE,                                                    KC_NO,              TD(U_TD_U_BASE),    TD(U_TD_U_SYM), KC_DOT,         KC_SLSH, KC_NO,
                                                                    KC_LPRN,            KC_RPRN,            U_MDASH,            KC_NO,              KC_NO,              KC_NO
  ),

  [U_FUN] = LAYOUT_split_3x6_3(
    KC_NO,  KC_F12,             KC_F7,          KC_F8,              KC_F9,              KC_F15,                                                     TD(U_TD_PSCR),      OSM(MOD_LSFT),      OSM(MOD_LCTL),  OSM(MOD_RALT),  OSM(MOD_LGUI), KC_NO,
    KC_NO,  KC_F11,             KC_F4,          KC_F5,              KC_F6,              KC_F14,                                                     KC_SCRL,            OSM(MOD_RSFT),      OSM(MOD_RCTL),  OSM(MOD_LALT),  OSM(MOD_RGUI), KC_NO,
    KC_NO,  KC_F10,             KC_F1,          KC_F2,              KC_F3,              KC_F13,                                                     KC_PAUS,            TD(U_TD_U_BASE),    TD(U_TD_U_FUN), TD(U_TD_MAC),   QK_BOOT, KC_NO,
                                                                    KC_APP,             KC_SPC,             KC_TAB,             KC_NO,              KC_NO,              KC_NO
  ),

  [U_NUMPAD] = LAYOUT_split_3x6_3(
    KC_NO,  OSM(MOD_RGUI),      OSM(MOD_RALT),  OSM(MOD_RCTL),      OSM(MOD_RSFT),    KC_NO,                                                        KC_PAST,            KC_P7,              KC_P8,          KC_P9,          KC_PMNS, KC_NO,
    KC_NO,  OSM(MOD_LGUI),      OSM(MOD_LALT),  OSM(MOD_LCTL),      OSM(MOD_LSFT),    KC_BSPC,                                                      KC_PEQL,            KC_P4,              KC_P5,          KC_P6,          KC_PPLS, KC_NO,
